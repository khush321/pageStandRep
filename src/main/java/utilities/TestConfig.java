...
public class TestConfig{
	...
	public static String from = "palgill8839@gmail.com";
	public static String password = "Manpreet0526@";
	public static String[] to ={"palgill8839@gmail.com","manpreet0526@gmail.com"};
